...
func TestHTTPAuthenticationAndAuthorizationContract(t *testing.T) {
	...
	// Expanded CodeBuddy/Kimi family coverage can take over seven minutes before
	// the final shared Search checks. Budget the complete sequence plus runner
	// variation; each individual operation keeps its own deadline and assertions.
