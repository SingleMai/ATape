...
from macOS arm64. It supports linear primary CLI Sessions, native `--fork-session` (including nested forks, copied foreground child trees, new foreground children and validated child continuation), ordinary resume,
