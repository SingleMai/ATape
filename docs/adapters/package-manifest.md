...
The [CodeBuddy Code CLI Adapter](codebuddy.md), [Kimi Code CLI Adapter](kimi.md) and [Grok Build Adapter](grok.md) also use this capability for bounded local JSONL snapshots.
